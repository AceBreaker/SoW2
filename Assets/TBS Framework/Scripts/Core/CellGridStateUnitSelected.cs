...
class CellGridStateUnitSelected : CellGridState
{
    ...
    public override void OnCellClicked(Cell cell)
    {
        ...
        else
        {
            ...
            _unit.SendMoveInformation(cell);
    ...
    public override void OnStateEnter()
    {
        ...
        {
            if (currentUnit.PlayerNumber.Equals(_unit.PlayerNumber) && _unit.typeOfTargets == Target.ENEMY)
                continue;
            else if (currentUnit.PlayerNumber.Equals(_unit.PlayerNumber) == false && _unit.typeOfTargets == Target.FRIENDLY)
                continue;
